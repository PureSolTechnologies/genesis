...
public class TransformationMetadata {
    ...
    public TransformationMetadata(SequenceMetadata sequenceMetadata, String developer, String command, String comment) {
	super();
	...
	result = prime * result + ((sequenceMetadata == null) ? 0 : sequenceMetadata.hashCode());
	return result;
    }
	...
	return "Transformation step on sequence '" + sequenceMetadata + "': " + command + " (" + comment + ") by "
		+ developer;
    }
}
