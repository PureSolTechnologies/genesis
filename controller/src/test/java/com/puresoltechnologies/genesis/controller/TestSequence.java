...
public class TestSequence implements TransformationSequence {
    ...
    public TestSequence(String componentName, Version startVersion, Version targetVersion, Version finalVersion) {
	super();
	...
	return new SequenceMetadata(componentName, startVersion, new ProvidedVersionRange(targetVersion, finalVersion));
    }
	...
	return "Sequence from " + startVersion + " to " + targetVersion + " for " + componentName;
    }
}
